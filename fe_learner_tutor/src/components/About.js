                ...
                <section id="about" className="about">
                    <div className="container" data-aos="fade-up">
                        <div className="row">
                            ...
                            <p>For "Video" courses, you can request a refund within 7 days of your successful purchase.
                                 For "Class" courses, you can request a refund within 7 days of the course starting date.</p>
